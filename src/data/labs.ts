...
export const LABS: Lab[] = [
  ...
  },
  {
    ...
    founders: [
      ...
      { person: 'ben-mildenhall', prior: ['google', 'fyusion', 'pixar', 'berkeley'] },
    ],
  ...
  },
  {
    ...
    founders: [
      ...
      { person: 'meelan-lee', prior: ['chipletz', 'google', 'qualcomm', 'atheros'] },
      { person: 'michael-carbin', prior: ['mit', 'microsoft', 'mosaicml'] },
      { person: 'sara-achour', prior: ['stanford', 'sendyne', 'aarno', 'qualcomm', 'salk'] },
    ],
    knownFor:
