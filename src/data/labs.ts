...
export const LABS: Lab[] = [
  ...
  },
  {
    ...
    founders: [
      ...
      { person: 'andrew-tulloch', prior: ['openai'], departed: true },
    ],
    knownFor:
  ...
  },
  {
    ...
    founders: [
      ...
      { person: 'alexandre-lebrun', prior: ['startup'] },
    ],
  ...
  },
  {
    ...
    domain: 'compute',
    founders: [
      { person: 'anna-goldie', prior: ['google', 'anthropic', 'stanford'] },
      { person: 'azalia-mirhoseini', prior: ['google', 'anthropic', 'stanford'] },
    ],
  ...
  },
  {
    ...
    tags: ['agents'],
    founders: [
      { person: 'charles-kantor', prior: ['stanford'] },
      { person: 'laurent-sifre', prior: ['deepmind'] },
      { person: 'karl-tuyls', prior: ['deepmind'], departed: true },
      { person: 'daan-wierstra', prior: ['deepmind'], departed: true },
      { person: 'julien-perolat', prior: ['deepmind'], departed: true },
    ],
    knownFor:
  ...
  },
  {
    ...
    founders: [
      ...
      { person: 'matthew-mcpartlon' },
      { person: 'jacques-boitreaud' },
    ],
  ...
  },
  {
    ...
    tags: ['video'],
    founders: [
      { person: 'naeem-talukdar', prior: ['startup'] },
      { person: 'mateusz-malinowski', prior: ['deepmind'] },
      { person: 'mikolaj-binkowski', prior: ['deepmind'] },
      { person: 'john-thomas', prior: ['startup'] },
    ],
  ...
  },
  {
    ...
    tags: ['multimodal'],
    founders: [
      { person: 'yi-tay', prior: ['google'], departed: true },
      { person: 'cyprien-de-masson-dautume', prior: ['deepmind'] },
      { person: 'dani-yogatama', prior: ['deepmind'] },
      { person: 'qi-liu' },
    ],
  ...
  },
  {
    ...
    domain: 'neuro',
    founders: [
      { person: 'sam-altman', prior: ['openai'], isBacker: true },
      { person: 'sumner-norman', prior: ['caltech', 'forestneuro'] },
      { person: 'mikhail-shapiro', prior: ['caltech'] },
    ],
  ...
  },
  {
    ...
    domain: 'inference',
    founders: [
      { person: 'simon-mo', prior: ['berkeley'] },
      { person: 'woosuk-kwon', prior: ['berkeley'] },
      { person: 'kaichao-you', prior: ['tsinghua'] },
    ],
