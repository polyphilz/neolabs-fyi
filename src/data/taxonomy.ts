...
export const ORGS: Record<OrgId, { label: string; group: LineageGroup }> = {
  ...
  samsung: { label: 'Samsung', group: 'bigtech' },
  tencent: { label: 'Tencent', group: 'bigtech' },
  hulu: { label: 'Hulu', group: 'bigtech' },
  ...
  recurrentai: { label: 'Recurrent AI', group: 'startup' },
  cruise: { label: 'Cruise', group: 'startup' },
  ...
  gsr: { label: 'GSR Ventures', group: 'startup' },
  funplus: { label: 'FunPlus', group: 'startup' },
  booz: { label: 'Booz & Company', group: 'startup' },
